...
signed char Shift[8]={5,-3,3,0,0,0,0,0};
...
byte NofStep[2] = {0, 0} , NofDiam [2] = {0, 0} ; // Noofstep - just to inicialize , NoofDiam 2 is for 2 elements of all motion of model  .
...
pinMode(A1,OUTPUT);
  ...
  Serial.begin(9600);
 Serial.print(F("Digger v33 date 20211020 "));
  pinMode (13 , OUTPUT);
